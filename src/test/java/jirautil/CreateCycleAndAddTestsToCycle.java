...
//public class CreateCycleAndAddTestsToCycle {
//
...
//            e1.printStackTrace();
//        }
//        CreateCycleAndAddTestsToCycle cc = new CreateCycleAndAddTestsToCycle();
//        String cycleID = cc.createCycle(createCycleUri, client, accessKey, cycleJSON);
//        LogUtil.infoLog(CreateCycleAndAddTestsToCycle.class, "Cycle Created with Cycle Id : " + cycleID);
//
//        // Add tests to Cycle IssueId's
//
//        String addTestsUri = zephyrBaseUrl + "/public/rest/api/1.0/executions/add/cycle/" + cycleID;
//        // Issue Ids to be added to Test Cycle, add more issueKeys separated by comma
//        String[] issueIds = {"TES01-6"};
//
//
...
//        LogUtil.infoLog(CreateCycleAndAddTestsToCycle.class, "ID is " + ID);
//    }
//
//    /**
//     * This method creates a Test Cycle in Jira.
//     *
//     * @param uriStr    URI of your Jira instance
//     * @param client    Object of ZFJCloudRestClient
//     * @param accessKey Access of the user performing the action
//     * @param cycleJSON JSON body to be sent to the request
//     * @return cycleId
//     * @throws URISyntaxException Exception if the Syntax is incorrect
...
//        LogUtil.infoLog(CreateCycleAndAddTestsToCycle.class, "URI is " + uri);
//        LogUtil.infoLog(CreateCycleAndAddTestsToCycle.class, "JWT is " + jwt);
//
...
//        LogUtil.infoLog(CreateCycleAndAddTestsToCycle.class, "Status Code is " + statusCode);
//        String cycleId = "-1";
...
//
//    /**
//     * This method adds tests to a Test Cycle in Jira.
//     *
//     * @param uriStr       URI of your Jira instance
//     * @param client       Object of ZFJCloudRestClient
//     * @param accessKey    Access of the user performing the action
//     * @param addTestsJSON JSON body to be sent to the request
//     * @return testId
//     * @throws URISyntaxException    Exception if the Syntax is incorrect
//     * @throws JSONException         Exception if the JSON body is incorrect
//     * @throws IllegalStateException Exception if an Illegal State is reached
//     */
//    @SuppressWarnings({"resource", "unused"})
//    public String addTestsToCycle(String uriStr, ZFJCloudRestClient client, String accessKey, StringEntity addTestsJSON)
//            throws URISyntaxException, JSONException, IllegalStateException {
//
//        URI uri = new URI(uriStr);
//        int expirationInSec = 360;
//        JwtGenerator jwtGenerator = client.getJwtGenerator();
...
//        int statusCode = response.getStatusLine().getStatusCode();
//        LogUtil.infoLog(CreateCycleAndAddTestsToCycle.class, "Status Code is " + statusCode);
//        LogUtil.infoLog(CreateCycleAndAddTestsToCycle.class, "Response is " + response);
//        String string = null;
//        if (statusCode >= 200 && statusCode < 300) {
//            HttpEntity entity = response.getEntity();
//            try {
